...
**Description:** All data stored on the on-chain is visible to anyone, and can be read directly from the blockchain. The `PasswordStore::s_password` variable is intended to be a private variable and only accessed through the `PasswordStore::getPassword` function, which is intended to be only called by the owner of the contract.
...
```
cast storgae <ADDRESS_HERE> 1 --rpc-url http://127.0.0.1:8545
```
